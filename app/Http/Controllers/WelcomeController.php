...
class WelcomeController extends Controller
{
    public function index()
    {
        ...
        // Ambil laporan terbaru (yang public)
    ...
    public function about()
    {
        $teamMembers = [
            [
                ...
                'bio' => 'Berpengalaman dalam pengembangan sistem informasi dan aplikasi berbasis web.',
                'photo' => 'https://ui-avatars.com/api/?name=Tim+Dev&background=0D8ABC&color=fff&size=200'
            ],
            [
                'name' => 'Tim Layanan Masyarakat',
                'role' => 'Layanan Masyarakat',
                'bio' => 'Berkomitmen untuk memberikan pelayanan terbaik bagi masyarakat.',
                'photo' => 'https://ui-avatars.com/api/?name=Tim+Layanan&background=0D8ABC&color=fff&size=200'
            ]
        ];
