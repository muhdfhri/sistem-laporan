...
<body class="font-sans text-gray-900 antialiased" style="background: linear-gradient(135deg, #f87171 0%, #ef4444 25%, #ec2e2e 50%, #b91c1c 75%, #d74a4a 100%); min-height: 100vh;">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 px-4">
        ...
        <div class="text-center mb-8">
            <h1 class="text-white text-3xl font-bold drop-shadow-2xl mb-2">Desa Sunggal Kanan</h1>
        ...
        <!-- Footer -->
        <p class="text-white text-xs mt-6 drop-shadow-lg">© 2025 Desa Sunggal Kanan - Kabupaten Deli Serdang</p>
    </div>
</body>
</html>